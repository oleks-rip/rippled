...
void wasmtime2_error_message(const wasmtime_error_t *error,
                                            wasm_name_t *message)
{
    return wasmtime_error_message(error, message);
}
...
wasmtime_error_t *
wasmtime2_config_target_set(wasm_config_t* c, char const *v)
{
  return wasmtime_config_target_set(c, v);
}
